# CI/CD Test Project  
In this project, following key technologies have been used:  
1. Docker Compose  
2. Django  
3. Nginx  
4. uWSGI  
...
1. Docker Container 1: Django app & uWSGI  
2. Docker Container 2: Nginx  
3. Docker Container 3: Postgresql database  
